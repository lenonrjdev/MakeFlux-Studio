...
test("o SQLite evolui para schema v6", () => { const dados=ler("src-tauri/src/commands/dados.rs"); assert.match(dados,/provedores_ia/); assert.match(dados,/execucoes_ia/); assert.match(dados,/PRAGMA user_version = 6/); });
